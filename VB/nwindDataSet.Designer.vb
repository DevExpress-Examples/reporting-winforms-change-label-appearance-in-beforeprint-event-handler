	...
	Partial Public Class nwindDataSet
		...
		Partial Public Class OrderDetailsDataTable
			...
			Public Function AddOrderDetailsRow(ByVal OrderID As Integer, ByVal Quantity As Short, ByVal UnitPrice As Decimal, ByVal ProductName As String, ByVal Discount As Single) As OrderDetailsRow
				...
				Dim columnValuesArray() As Object = { OrderID, Quantity, UnitPrice, ProductName, Discount}
...
Namespace BeforePrintEvent.nwindDataSetTableAdapters
	...
	Partial Public Class OrderDetailsTableAdapter
		...
		Private Sub InitCommandCollection()
			...
			Me._commandCollection(0).CommandText = "SELECT        OrderID, Quantity, UnitPrice, ProductName, Discount" & Constants.vbCrLf & "FROM          " & "  OrderDetails"
